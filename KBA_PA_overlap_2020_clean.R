...
fields <- colnames(select(isos, c("country_SIS", "countryname","Developing","LDC","LLDC_SIDS","IPBES_region", "region", "SDG_Region","ISO_BL","ISO_SDG","SDG_Subregion"))) #select relevant columns from ISO table
