...
sdg_format_1 <- function(){
  ...
  fls2 <- fls[grepl("ISO_SDG|R SDG_Region|R SDG_Subregion|R Developed_Developing|R global|R LDC|R LLDCs_SIDs|R Europe_NorthernAmerica_Australia_NewZealand", fls)] #TODO add needed regional groups to this
